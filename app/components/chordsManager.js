...
Ext.define( "chords.components.chordsManager", {
    ...
    regex: function () {
         ...
         */
        var chordBase = "[A-H][\\#b]?(?:m|Minor|Major)?(5|9b5|6add9|maj|maj7|maj9|maj11|maj13|maj9#11|maj13#11|6|add9|maj7b5|maj7#5||min|m7|m9|m11|m13|m6|madd9|m6add9|mmaj7|mmaj9|m7b5|m7#5|7|9|11|13|7sus4|7b5|7#5|7b9|7#9|7b5b9|7b5#9|7#5b9|9#5|13#11|13b9|11b9|aug|dim|dim7|sus4|sus2|sus2sus4|-5|7h5)?(?:/[A-H][\\#b]?)?";
    ...
    breakLongLines: function ( chordLine, textLine, lineLength ) {
        ...
        if( chordLine.length || textLine.length ) {
            return '<p class = "chords">' + this.wrapChordsInLine( chordLine.substr( 0, lineLength ) ) + '</p>' +
